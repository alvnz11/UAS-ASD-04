public class DLL {
    ...
    public void add(Kendaraan item) {
        if(isEmpty()) {
    ...
    public void print() {
        if(isEmpty()) {
            ...
            int i = 1;
            System.out.println("---------------------------------------------------------------------------------------------");
            System.out.printf("| %-12s | %-12s | %-10s | %-15s | %-8s | %-12s |\n", "Nomer TNKB", "Nama Pemilik", "Jenis", "CC Kendaraan", "Tahun", "Bulan Harus Bayar");
            System.out.println("---------------------------------------------------------------------------------------------");
            while(tmp != null) {
                System.out.printf("| %-12s | %-12s | %-10s | %-15s | %-8s | %-17s |\n", tmp.data.noTNKB, tmp.data.nama, tmp.data.jenis, tmp.data.cc, tmp.data.tahun, tmp.data.bulanHarusBayar);
                tmp = tmp.next;
                i++;
            }
            System.out.println("---------------------------------------------------------------------------------------------");
            System.out.println("Jumlah Kendaraan: " + (i-1) + "\n");
        }
    }
